...
import { User,  Heart, ArrowRight, ArrowLeft, Check, FileText} from "lucide-react";
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:gap-6">
                    ...
                    {formData.hasChildren === "yes" && (
                      <>
                        ...
                        <div>
                          <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Children’s Ages</label>
                          <input
                            type="text"
                            name="childrenAges"
