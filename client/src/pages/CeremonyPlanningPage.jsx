...
const CeremonyPlanningPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div ref={heroRef} className="relative overflow-hidden bg-gradient-to-r from-pink-400 to-pink-600 text-white">
        <motion.div 
        ...
        >
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-pink-100">Find the perfect venue and vendors for your special day.</p>
          </motion.div>
        </motion.div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-pink-400 to-pink-600 rounded-2xl p-8 md:p-12 text-center max-w-4xl mx-auto mb-20"
        >
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-white text-pink-700 px-8 py-4 rounded-lg font-semibold shadow-lg hover:bg-pink-50 transition duration-300"
          ...
          >
            ...
            >
              ...
              <div className="bg-pink-50 p-4 rounded-xl mb-6">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-pink-700">${selectedVenue.price}</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="flex-1 bg-pink-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-pink-700 transition duration-300 text-center">
                  Book Venue
                </button>
                <button className="flex-1 bg-white border border-pink-600 text-pink-600 py-3 px-6 rounded-lg font-semibold hover:bg-pink-50 transition duration-300 text-center">
                  Contact
                </button>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <svg className="h-6 w-6 mr-3 text-pink-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  {['facebook', 'twitter', 'instagram'].map(social => (
                    <a key={social} href="#" className="text-gray-400 hover:text-pink-600 transition duration-300">
      ...
      {screenSize === 'mobile' && (
        ...
        >
          <button 
            className="bg-pink-600 text-white w-14 h-14 rounded-full shadow-lg flex items-center justify-center hover:bg-pink-700 transition-colors"
