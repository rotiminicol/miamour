...
const MarriagePlanning = () => {
  ...
  const ContactPopup = () => (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      >
        <h3 className="font-serif text-2xl font-semibold mb-4 text-pink-900">Contact Miamour</h3>
        <div className="space-y-4 mb-6">
          <div className="flex items-start">
            <svg className="w-5 h-5 text-pink-600 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-start">
            ...
            <div>
              <p className="font-medium text-pink-900">Address</p>
        ...
        <button 
          ...
          className="w-full bg-pink-600 text-white font-medium py-2 px-4 rounded-lg hover:bg-pink-700 transition-colors"
        >
          Close
        </button>
      </motion.div>
  ...
  return (
    <div className="min-h-screen bg-white">
      <Header />
      <div className="relative bg-gradient-to-r from-pink-500 to-pink-700 text-white overflow-hidden parallax-hero">
        <motion.div 
      ...
      <div className="container mx-auto px-4 py-12">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="mb-12">
          <h2 className="font-serif text-3xl font-semibold text-center mb-8 text-pink-900">Our Wedding Planning Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                <h3 className="font-serif text-xl font-semibold mb-4 text-pink-900">{service.title}</h3>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="bg-gradient-to-r from-pink-500 to-pink-700 rounded-2xl p-8 text-center max-w-4xl mx-auto mb-12 parallax-section">
          <h2 className="font-serif text-3xl font-semibold mb-4 text-white">Ready to Start Planning?</h2>
          <button 
            onClick={() => setShowContactPopup(true)}
            className="inline-block bg-white text-pink-700 font-semibold py-3 px-8 rounded-lg shadow-lg hover:bg-pink-50 transition-colors"
          >
            Get in Touch
          </button>
        </motion.div>
