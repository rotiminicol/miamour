...
const SignUpForm = () => {
  ...
  const { signup, loading, socialLogin } = useAuthStore();
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8 max-w-xl w-full mx-auto">
      ...
      <div className="relative flex items-center justify-center mb-6">
        ...
        <span className="bg-white px-3 text-sm text-gray-500 absolute">or sign up with email</span>
      </div>
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          {/* Gender Field */}
          <div>
            <label className="block text-sm font-medium text-pink-700">Your Gender</label>
            <div className="mt-2 flex gap-4">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="male" className="ml-2 block text-sm text-pink-700">
                  Male
                </label>
              </div>
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-pink-600 focus:ring-pink-500"
                />
                <label htmlFor="female" className="ml-2 block text-sm text-pink-700">
                  Female
                </label>
              </div>
            </div>
        ...
        <div>
          <label className="block text-sm font-medium text-pink-700">Prefer Me</label>
          <div className="mt-2 flex flex-wrap gap-4">
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-pink-600 focus:ring-pink-500"
              />
              <label htmlFor="prefer-male" className="ml-2 block text-sm text-pink-700">
                Male
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-pink-600 focus:ring-pink-500"
              />
              <label htmlFor="prefer-female" className="ml-2 block text-sm text-pink-700">
                Female
              </label>
            </div>
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-pink-600 focus:ring-pink-500"
              />
              <label htmlFor="prefer-both" className="ml-2 block text-sm text-pink-700">
                Both
              </label>
            </div>
          </div>
