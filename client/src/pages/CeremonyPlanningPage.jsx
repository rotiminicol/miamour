...
import { MapPin, Users, Calendar, Clock, ChevronRight, Phone, Mail, Sparkles, X, ChevronLeft } from 'lucide-react';
        ...
        {selectedVenue && (
          ...
          >
            <motion.div 
              ...
              className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full p-6 md:p-8 my-8 max-h-[90vh] overflow-y-auto"
        ...
        {showContactModal && (
          ...
          >
            <motion.div 
              ...
              exit={{ opacity: 0, y: 50 }}
              transition={{ type: "spring", damping: 25 }}
              className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl max-w-md w-full p-6 md:p-8 border border-pink-100 my-8 max-h-[90vh] overflow-y-auto"
              onClick={e => e.stopPropagation()}
            >
                ...
                {[
                  {
                    ...
                    title: "Phone",
                    content: "+234 9044130171"
                  },
                  {
                    icon: <Mail className="h-6 w-6 text-pink-500" />,
                    title: "Email",
                    content: "info@miamour.me"
                  },
                  {
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 whitespace-pre-line">
                        {item.title === "Phone" ? (
                          <a href={`tel:${item.content}`} className="hover:text-pink-500 transition-colors">
                            {item.content}
                          </a>
                        ) : item.title === "Email" ? (
                          <a href={`mailto:${item.content}`} className="hover:text-pink-500 transition-colors">
                            {item.content}
                          </a>
                        ) : (
                          item.content
