  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-indigo-600 to-purple-700 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-lg text-indigo-100 mb-8 max-w-2xl mx-auto">Our AI connects you with compatible partners based on personality and values.</p>
      ...
      <div className="container mx-auto px-4 py-12">
        <motion.div id="features" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="mb-12">
            ...
            {features.map((feature, index) => (
              <motion.div key={index} whileHover={{ y: -5 }} className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl">
                <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-indigo-600" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d={feature.icon} clipRule="evenodd"/></svg>
                </div>
        ...
        <motion.div id="how-it-works" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="mb-12">
            ...
            {howItWorks.map((step, index) => (
              <motion.div key={index} whileHover={{ y: -5 }} className="text-center">
                <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-indigo-600 font-bold text-xl">{step.step}</span>
                </div>
        ...
        <motion.div id="testimonials" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="mb-12">
              ...
              <motion.div key={index} whileHover={{ y: -5 }} className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-indigo-600">Matched {testimonial.date}</div>
                  </div>
                </div>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="bg-gradient-to-r from-indigo-600 to-purple-700 rounded-2xl p-8 text-center max-w-4xl mx-auto mb-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a 
              ...
              className="bg-white text-indigo-700 px-6 py-3 rounded-lg font-semibold hover:bg-indigo-50 flex items-center justify-center"
            >
