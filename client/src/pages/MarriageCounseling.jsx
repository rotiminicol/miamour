    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-r from-pink-500 to-pink-700 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <motion.button whileHover={{ scale: 1.05 }} className="bg-white text-pink-600 px-8 py-4 rounded-lg font-semibold shadow-lg hover:bg-pink-50">Begin Your Journey</motion.button>
          </motion.div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <motion.button whileHover={{ scale: 1.05 }} className="bg-white text-pink-600 px-8 py-4 rounded-lg font-semibold shadow-lg hover:bg-pink-50">
        ...
        {selectedCounselor && (
          ...
          >
            ...
            >
              ...
              <button className="w-full bg-pink-600 text-white py-3 rounded-lg font-semibold hover:bg-pink-700">Book Appointment</button>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
