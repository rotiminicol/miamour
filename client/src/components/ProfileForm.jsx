...
const ProfileForm = ({ onSubmit, initialData = {}, isSidebarOpen = true }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    pictures: initialData.pictures || [], // Array to store up to 5 image files or URLs
  ...
  const isStepComplete = (step) => {
    if (step === 1) {
      return formData.name && formData.age && formData.gender && formData.location && formData.email && formData.pictures.length >= 5;
    } else if (step === 2) {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen">
      ...
      <header className="bg-white border-b border-gray-200 py-4 px-6 flex items-center justify-between">
        ...
        <div className="text-xs sm:text-sm text-gray-500">Complete your profile to find your perfect match</div>
      </header>
    
      {/* Main Content */}
      <div className="flex-grow flex justify-center">
        <div className={`w-full transition-all duration-300 ease-in-out ${isSidebarOpen ? 'px-4 md:px-8 lg:px-12' : 'px-2 sm:px-4 md:px-8 lg:px-16'}`}>
          {/* Centered and responsive container */}
          <div className="max-w-full sm:max-w-md md:max-w-2xl lg:max-w-4xl mx-auto pb-12 pt-6">
            {/* Progress Steps */}
            ...
            >
              <AnimatePresence mode="wait">
                {currentStep === 1 && (
                  <motion.div 
                    ...
                    className="space-y-6"
                  >
                    <h2 className="text-xl sm:text-2xl font-semibold flex items-center text-gray-800 mb-6">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:gap-6">
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Full Name *</label>
                        <input
                          type="text"
                          name="name"
                          value={formData.name}
                          ...
                          className="w-full p-3 sm:p-4 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500"
                        />
                      </div>
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Age *</label>
                        <input
                          type="text"
                          name="age"
                          value={formData.age}
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Gender *</label>
                        <select
                          name="gender"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Location *</label>
                        <input
                          type="text"
                          name="location"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Email *</label>
                        <input
                          type="email"
                          name="email"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Phone</label>
                        <input
                          type="tel"
                          name="phone"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">
                        ...
                        {formData.pictures.length < 5 && (
                          <div className="text-sm text-pink-600 mb-2">
                            Please upload at least {5 - formData.pictures.length} more photos
                          </div>
                        )}
                            ...
                            <div key={index} className="relative group">
                              <img
                                ...
                                className={`w-20 h-20 sm:w-24 sm:h-24 object-cover rounded-lg border-2 ${
                                  picture.isPrimary ? 'border-pink-500' : 'border-transparent'
                                }`}
                              />
                              <button
                                type="button"
                        ...
                        <motion.button
                          ...
                          className={`w-full p-3 sm:p-4 text-sm sm:text-base rounded-lg flex items-center justify-center gap-2 ${
                            uploading 
                        ...
                        <div className="text-xs text-gray-500 mt-2">
                          Upload clear, high-quality photos that represent you well. Include at least one clear face photo.
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                {currentStep === 2 && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:gap-6">
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Profession *</label>
                        <input
                          type="text"
                          name="profession"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Education *</label>
                        <select
                          name="education"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Religion *</label>
                        <input
                          type="text"
                          name="religion"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Relationship Status *</label>
                        <select
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Previous Marriages *</label>
                        <select
                      ...
                      {(formData.relationshipStatus === "divorced" || formData.relationshipStatus === "separated") && (
                        <div>
                          <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Divorce/Separation Details</label>
                          <textarea
                            name="divorceDetails"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Do You Have Children? *</label>
                        <select
                          name="hasChildren"
                      ...
                      {formData.hasChildren === "yes" && (
                        <>
                          <div>
                            <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Number of Children</label>
                            <select
                          ...
                          <div>
                            <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Childrens Ages</label>
                            <input
                              type="text"
                              name="childrenAges"
                          ...
                          <div>
                            <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Living Arrangement</label>
                            <select
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Family Background</label>
                        <motion.textarea
                          name="familyBackground"
                          value={formData.familyBackground}
                          onChange={handleInputChange}
                          className="w-full p-3 sm:p-4 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 transition min-h-[120px]"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Hobbies & Interests</label>
                        <motion.textarea
                          name="hobbies"
                ...
                {currentStep === 3 && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:gap-6">
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Preferred Age Range *</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Location Preference</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Religious Preference *</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Education Preference</label>
                        <select
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Accept Partner with Children?</label>
                        <select
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Deal Breakers</label>
                        <motion.textarea
                          name="dealBreakers"
                      ...
                      <div>
                        <label className="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2 font-medium">Marriage Timeframe *</label>
                        <select
              ...
              <div className="flex flex-col sm:flex-row justify-between mt-8 gap-4 sm:gap-0">
                {currentStep > 1 ? (
                  <motion.button
                    ...
                    className="w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-3 text-sm sm:text-base bg-gray-100 text-gray-700 rounded-lg flex items-center justify-center transition hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-pink-300 font-medium"
                  >
                ...
                {currentStep < 3 ? (
                  <motion.button
                    ...
                    className={`w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-3 text-sm sm:text-base rounded-lg flex items-center justify-center transition focus:outline-none focus:ring-2 focus:ring-pink-300 font-medium
              ...
              {/* Help Text */}
              <div className="text-xs sm:text-sm text-gray-500 mt-6 text-center px-3 py-2 sm:px-4 sm:py-3 bg-gray-50 rounded-lg">
                <p>
