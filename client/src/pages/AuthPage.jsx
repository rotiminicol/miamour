...
const AuthPage = () => {
  ...
  return (
    <div className="flex justify-center items-center w-screen h-screen bg-gradient-to-br from-pink-100 to-purple-100 overflow-hidden">
      {/* Reduced number of floating hearts for performance */}
      ...
      >
        ...
        {/* Form Section - Updated to ensure proper scrolling */}
          ...
          <AnimatePresence mode="wait">
            {isLoginActive ? (
              ...
              <motion.div
                ...
                exit={{ opacity: 0, x: 50 }}
                transition={{ duration: 0.4 }}
                className="w-full h-full overflow-hidden" // Added overflow-hidden to contain the scrollable form
              >
